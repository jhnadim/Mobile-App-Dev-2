  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.cardView}>
        ...
        <MainCard title={'Evening'} temperature={TemperatureEvening + '°C'} backgroundColor={darkMode ? '#d29600' : '#fcc63f'} icon={'afternoon'}></MainCard>
        <MainCard title={'Night'} temperature={TemperatureNight + '°C'} backgroundColor={darkMode ? '#008081' : '#38b7b8'} icon={'night'}></MainCard>
      </View>

      <View style={styles.cardInfo}>
        <Text style={styles.cardInfoText}>Weather Information</Text>

        <View style={styles.cardInfoView}>
          <InfoCard title={'Prob. Of rain'} value={Rain + '%'}></InfoCard>
          <InfoCard title={'Humidity'} value={Humidity + '%'}></InfoCard>
          <InfoCard title={'Temp. Min'} value={TemperatureMin + '°C'}></InfoCard>
          <InfoCard title={'Temp. Max'} value={TemperatureMax + '°C'}></InfoCard>
        </View>

      </View>
       <Button
        title={'start forecast'}
        onPress={() => openForecastScreen()}></Button>
